...
- [`factory-security/`](factory-security/SKILL.md) — the security check Cowork runs on any sensitive PR before you merge: reads the change, reports only real problems in plain words, ends with one verdict — **MERGE** or **FIX-FIRST**.
