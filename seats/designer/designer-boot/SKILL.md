...
2. **Follow it exactly**: it will send you to `seats/_shared/BOOT-COMMON.md` first (the boot every seat shares — read it in full), then grounding links, `MECHANICAL-RULES.md`, `seats/designer/OVERRIDES.md`, and the top of `journal.md` and the recorded brand decisions — and confirm the boot per RULE 17.
